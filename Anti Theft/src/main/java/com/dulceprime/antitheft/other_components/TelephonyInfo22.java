...
public final class TelephonyInfo22 {
    private static TelephonyInfo22 telephonyInfo;
    ...
    private TelephonyInfo22() {
    }

    public static TelephonyInfo22 getInstance(Context context) {
        if (telephonyInfo == null) {
            telephonyInfo = new TelephonyInfo22();
